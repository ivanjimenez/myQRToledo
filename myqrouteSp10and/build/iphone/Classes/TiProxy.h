...
//Rare exceptions to indicate a bug in the _myqroutesp10and code (Eg, function that a subclass should have implemented)
...
/**
 The base class for myqrouteSp10and proxies.
 */
