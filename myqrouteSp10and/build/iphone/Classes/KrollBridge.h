...
@interface myqrouteSp10andObject : KrollCoverageObject {
#else
@interface myqrouteSp10andObject : KrollObject {
#endif
@private
...
extern NSString * myqrouteSp10and$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	myqrouteSp10andObject *_myqroutesp10and;
    KrollObject* console;
	BOOL shutdown;
