 ...
 * Copyright (c) 2009-2012 by myqrouteSp10and, Inc. All Rights Reserved.
...
//@interface myqrouteSp10andObject : NSObject
//@end

@interface myqrouteSp10andObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[myqrouteSp10andObject class]])
		{
			for (NSString *key in [[(myqrouteSp10andObject*)o modules] allKeys])
			{
