...
/**
 Base class for all myqrouteSp10and views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the myqrouteSp10and view hierarchy (such as wrapped iOS UIViews) was touched.
