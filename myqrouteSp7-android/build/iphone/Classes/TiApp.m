...
- (NSString*)userAgent
{
	if (userAgent==nil)
	{
		...
		NSString *kmyqrouteSp10andUserAgentPrefix = [NSString stringWithFormat:@"%s%s%s %s%s","Appc","eler","ator","Tita","nium"];
		userAgent = [[NSString stringWithFormat:@"%@/%s (%@)",kmyqrouteSp10andUserAgentPrefix,TI_VERSION_STR,currentDeviceInfo] retain];
	}
	return userAgent;
}
