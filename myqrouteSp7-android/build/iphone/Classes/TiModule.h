...
/**
 The base class for all myqrouteSp10and modules
 */
...
/**
 myqrouteSp10and Platform calls this method on startup.
 */
-(void)startup;

/**
 myqrouteSp10and Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 myqrouteSp10and Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 myqrouteSp10and Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 myqrouteSp10and Platform calls this method on resume.
 @param sender The sender of the event.
 */
