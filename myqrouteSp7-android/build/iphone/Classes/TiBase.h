...
// in simulator we redefine to format for myqrouteSp10and Developer console
...
{\
	NSString * exceptionName = [@"org.myqroutesp10and." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myqroutesp10and";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImyqrouteSp10andNativeItemNone = -1, 
	UImyqrouteSp10andNativeItemSpinner = -2,
	UImyqrouteSp10andNativeItemProgressBar = -3,
	
	UImyqrouteSp10andNativeItemSlider = -4,
	UImyqrouteSp10andNativeItemSwitch = -5,
	UImyqrouteSp10andNativeItemMultiButton = -6,
	UImyqrouteSp10andNativeItemSegmented = -7,
	
	UImyqrouteSp10andNativeItemTextView = -8,
	UImyqrouteSp10andNativeItemTextField = -9,
	UImyqrouteSp10andNativeItemSearchBar = -10,
	
	UImyqrouteSp10andNativeItemPicker = -11,
	UImyqrouteSp10andNativeItemDatePicker = -12,
	
	UImyqrouteSp10andNativeItemInfoLight = -13,
	UImyqrouteSp10andNativeItemInfoDark = -14,
	
	UImyqrouteSp10andNativeItemDisclosure = -15,
	
	UImyqrouteSp10andNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all myqrouteSp10and instances of
